    ...
    protected function getFormSchema(): array
    {
        return [
            Wizard::make([
                Step::make('Overview')
                    ...
                    ->schema([
                        Grid::make([
                            ...
                            ->schema([
                                FileUpload::make('cover_path')->directory('images')->multiple()->label('Cover Image')->columnSpan([
                                    'default' => 1,
                                    'sm' => 1,
                                    'lg' => 4,
                                ]),
                        ...
                        Grid::make([
                            ...
                            ->schema([
                                ...
                                Select::make('model')
                                    ->label('Model')
                                    ->dehydrateStateUsing(fn ($state) => Model::where('id', $state)->name)
                ...
                Step::make('Details')
                    ->description('Enter the body type of the vehicle')
                    ->schema([
                        Grid::make([
                            'default' => 1,
                            'sm' => 2,
                ...
                Step::make('Features')
                    ->description('Enter the features of the vehicle')
                     ->schema([
            ...
            ])->submitAction(view('components.new-vehicle-submit-button')),
        ];
