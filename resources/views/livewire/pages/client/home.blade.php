<div>
    <div class="relative">
        ...
        <div class="bg-white rounded-sm shadow-md px-12 py-10 absolute flex flex-col left-1/2 -translate-x-1/2 items-center top-14 self-center w-5/6 md:w-auto">
             <div class="rounded-full bg-gray-600 h-32 w-32"></div>
             <div class="text-center py-3 text-sm text-gray-500">@dynamic</div>
             <div class="text-center py-4 font-bold text-3xl">{{$owner->name}}</div>
             <div class="text-center text-base w-3/4 text-black">The best place to purchase or trade your vehicle</div>
        </div>     
    </div>
